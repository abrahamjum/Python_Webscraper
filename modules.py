...
def simple_get(url):
    """
    Attempts to get the content at 'url' by making an HHTP GET request.
    if the content-type of response is some kind of HTML/XML, return the
    text context, otherwise return None.
    """
    try:
...
def is_good_response(resp):
    """
    Returns True if the response seems to be HMTL, False otherwise.
    """
...
def get_hits_on_name(name):
    ...
    # url_root is a template of string that is used to build a URL.
